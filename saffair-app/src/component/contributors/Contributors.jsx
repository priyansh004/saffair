            ...
            >
              <div className="pdetails">
                ...
                <div className="thenames grid grid-cols-1 mb-2 md:grid-cols-2 sm:grid-cols-2 ">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-8 sm:flex-row">
                      ...
                      <Button
                        ...
                        disabled={isButtonDisabled}
                        onClick={() => sendOTP()}
                        className={`mr-0 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ${isButtonDisabled ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
                        <span>{isButtonDisabled ? "Sending..." : "Send code"}</span>
                      </Button>
                    </div>
                  ...
                  <div className="flex-col flex justify-between">
                    <div>
                      email verification <span className="text-red-500 ml-1">*</span>
                    </div>
                    <div className="flex flex-col gap-8 sm:flex-row">
                      <TextInput
                        type="text"
                      ...
                      <div className="flex-row">
                        ...
                        <Button
                          ...
                          onClick={handleVerifyCode} disabled={isVerifyButtonDisabled}
                          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                          {isVerifyButtonDisabled ? "Checking..." : "Verify email"}
